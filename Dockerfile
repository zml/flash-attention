# Docker is needed because compilation is not fully hermetic
# and will link whatever glibc is installed on the system
# and we need 2.34 specifically which comes with ubuntu 22.
FROM ubuntu:22.04
